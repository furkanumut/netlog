                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="status">
                                <option value="PUBLISHED" @if(isset($dataTypeContent->status) &&
                                    $dataTypeContent->status == 'PUBLISHED') selected="selected"@endif>{{
...
<script>
  ...
  codesample_languages: [
        {text: "HTML/XML/SVG/...", value: "markup"},
        {text: "CSS", value: "css"},
        ...
        {text: "C#", value: "csharp"},
        {text: "C++", value: "cpp"},
        {text: "Json + Web App Manifest", value: "markup-templating"}
        // https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+bash+c+csharp+cpp+json+markup-templating+php+python+sql
      ],
  skin_url: $('meta[name="assets-path"]').attr('content')+'?path=js/skins/voyager',
  toolbar: 'styleselect bold italic underline | searchreplace forecolor backcolor | alignleft aligncenter alignright | bullist numlist outdent indent | link image table | code codesample',
